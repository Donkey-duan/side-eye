    ...
    <>
      <section className={`policy ${siteView !== "faq" ? "site-hidden" : ""}`} id="faq">
        ...
        <div className="policy-body faq-list">
          ...
          <details className="faq-item">
            <summary>如果我正在經歷，這個網站在案件過程中具體能幫我什麼？</summary>
            <div>
              <p>性別事件發生後，當事人要面對的往往不只一個程序。他可能同時承受情緒反應與身體不適、家庭與伴侶關係的變化、工作或學業受到影響，還必須獨自弄懂報案、蒐證、校園性平調查、司法程序、申復與救濟這一整套陌生的制度。很多事情同時砸下來、卻又什麼都抓不穩，那種強烈的失控感，正是這個站想回應的處境。</p>
              <p>所以除了告訴你「法律規定是什麼」，它更想補上你在實際歷程中真正會用到的東西。幾個具體的例子：</p>
              <ul>
                <li><b>收到逐字稿或調查報告後，查委員是誰。</b>文件上會載明調查委員的姓名，你可以到全國性平委員名冊查他們的身分與專業背景，更清楚是哪些人在調查、判斷你的案件，也方便核對有沒有應迴避卻沒迴避的情形。</li>
                <li><b>開庭前後，查承審法官的判決歷史。</b>知道法官是誰之後，可以看他過去在性平相關案件處理過哪些爭點、看重哪類證據、判決理由怎麼寫，進法院前對可能面對的方向先有個底。</li>
                <li><b>看歷年統計，讓自己心裡有個底。</b>各罪名歷來的定罪率、量刑與屬實趨勢，幫你對「像我這樣的案件通常怎麼走」有大致的預期，不會被單一新聞或極端個案帶著走。</li>
                <li><b>照著程序與期限走，不錯過權利。</b>報案、校園性平、申復與救濟的順序和期限都整理過，還附行動準備清單，減少因為不熟悉制度而錯過時效的機會。</li>
              </ul>
              <p>這些都保證不了案件結果，也消不掉事件造成的傷害。明鏡最想做到的，不是替你決定該走哪條路，而是讓你知道事情可能怎麼進行、自己現在在哪個位置、接下來有哪些選擇。<b>當很多事情都暫時無法掌握時，至少先幫你把失序的生活，拉回一點掌控感。</b></p>
            </div>
          </details>
          <details className="faq-item">
